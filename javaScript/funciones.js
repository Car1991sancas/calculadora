...
function Resolver(operador){
	...
	switch(operador){
		case'+':
		document.getElementById("operador").src="suma.jpg";
		R[0]=F1[0]*F2[1]+F1[1]*F2[0];
		R[1]=F1[1]*F2[1];
		break;
		
			case'-':
		document.getElementById("operador").src="resta.jpg";
		R[0]=F1[0]*F2[1]-F1[1]*F2[0];
		R[1]=F1[1]*F2[1];
		break;
		
			case'*':
		document.getElementById("operador").src="MULTIP1.jpg";
		R[0]=F1[0]*F2[0];
		R[1]=F1[1]*F2[1];
		break;
			
			case'/':
		document.getElementById("operador").src="division.jpg";
		R[0]=F1[0]*F2[1];
		R[1]=F1[1]*F2[0];
		break;
		}
